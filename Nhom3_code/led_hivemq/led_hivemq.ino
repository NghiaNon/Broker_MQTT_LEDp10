...
const char *ssid         = "HUS";  // Wi-Fi 
const char *password     = "12345678";
bool clnt_state = 0 ;

const char *mqtt_broker = "broker.hivemq.com"; // mqtt broker 
const char *topic = "esp12f/buttonStatus"; // TOPIC !!!
...
void setup() {
  ...
  P10.setBrightness(20);    // do sang led
...
void loop() {
  ...
  client.loop();       // tin nhan duoc gui nguoc lai
